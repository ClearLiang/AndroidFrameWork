...
public class ZoomImageView extends ImageView {
    ...
    public void setSourceImageBitmap(Bitmap bitmap, Activity activity) {
        sourceBitmap = bitmap;
        int screenWidth = ((WindowManager) (BaseApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getWidth();
        int screenHeight = ((WindowManager) (BaseApplication.getInstance().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getHeight();
