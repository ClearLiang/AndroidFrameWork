...
//                EventBusUtil.sendEvent(new Event(EventCode.REFRESH_HOME_LIST));
    ...
    private void processCustomMessage(Context context, Bundle bundle) {
        ...
        /*if (TextUtils.isEmpty(title)) {
            Log.d(TAG, "push title is empty");
            return;
        }

        String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
        Log.d(TAG, "push extrasJson:" + extras);*/

        Intent intent = new Intent("com.clearliang.AnotherBroadcastReceiver");
